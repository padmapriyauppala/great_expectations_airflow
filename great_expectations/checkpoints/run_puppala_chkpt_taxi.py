...
Usage:
- Run this file: `python great_expectations/uncommitted/run_puppala_chkpt_taxi.py`.
...
data_context: FileDataContext = get_context(context_root_dir="/home/padmapriya/GX/gx_tutorials/great_expectations")
